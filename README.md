...
Скрипт написан для [livelib.ru](https://www.livelib.ru/). Позволяет собирать информацию по книгам нужного раздела. Используется в личных целях, когда хочется почитать.
